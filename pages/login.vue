  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center p-4 sm:p-6">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 sm:p-10">
      ...
      <p class="mt-6 text-center text-sm text-gray-500">
        Belum punya akun?
        <NuxtLink to="/register" class="text-blue-600 hover:text-blue-800 font-medium">Daftar sekarang</NuxtLink>
      </p>

      <p class="mt-4 text-center text-xs text-gray-400">🔒 Semua data user telah di enkripsi di server</p>
    </div>
  </div>
</template>
